...
import (
	...
	"github.com/cnapp/cnapp-go-grpc/pkg/middleware"
	// "github.com/cnapp/cnapp-go-grpc/pb/v2beta"
)

func registerServer(conf *config.Configuration, grpcAddr string) (*grpc.Server, error) {
